//***********************************************************//
//***********************************************************//
//***  2017F OS Assignment 1 Due 10/19 Thu.          ********//
//***  A simple shell with pipe and redirection      ********//
//***                                                ********//
//***  Max length of command is set to 1024,         ********//
//***       it can be changed by modifying line 22   ********//
//***                                                ********//
//***  implement in CS linux work station            ********//
//***                                   by 0416235   ********//
//***********************************************************//
//***********************************************************//
...
//-----------------------------------------------------------//
//--- start to fork process ---------------------------------//
//-----------------------------------------------------------//	

	pid_t pid;
        pid_t df_pid;
        //if & or | appears, double fork
        if(et!=0 | pipe!=0 ) {
